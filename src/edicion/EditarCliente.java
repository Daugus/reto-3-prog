...
public class EditarCliente extends JFrame implements ActionListener, FocusListener, WindowListener {
	...
	public EditarCliente() {
		...
		camposTexto.addAll(Arrays.asList(txtDNI, txtNombre, txtApellidos, txtTel, txtEmail, txtFechaAltaD,
				txtFechaAltaM, txtFechaAltaA, txtFechaNacimientoD, txtFechaNacimientoM, txtFechaNacimientoA,
				txtCodPostal, txtCalle, txtPortal, txtPiso, txtPuerta, txtMatricula));
		...
		etiquetas.addAll(Arrays.asList(lblDNI, lblNombre, lblApellidos, lblTel, lblEmail, lblFechaNacimiento,
				lblCodPostal, lblCalle, lblPortal, lblPiso, lblPuerta, lblFechaAlta, lblVehiculos, lblMatricula));
					...
					for (String ma : alMatriculasBorradas) {
						...
						JOptionPane.showMessageDialog(this,
								(String) "El vehículo con la matrícula " + ma
										+ " ya no tiene un propietario seleccionado",
