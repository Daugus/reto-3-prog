...
public class OrdenTabulacion extends FocusTraversalPolicy
{
	...
	/**
	 * Este Componente será el primero 
	 * en recibir el foco cuando se desplace hacia un nuevo 
	 * ciclo transversal de foco enraizado en un Contenedor.
	...
	/**
	 * This method is usedto determine the next Component to 
	 * focus when traversal wraps in theforward direction.
	 * este metodo es usado para determinar el siguiente componente de la posicion ultima 
